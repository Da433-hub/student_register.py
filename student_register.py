...
"""
This program creates a text file called 'reg_form.txt' The form lists student identification numbers, adding dotted lines for the students to sign their names next to their ID numbers.
"""
